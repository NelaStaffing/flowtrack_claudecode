...
-- ============================================================
-- NOTE: This assumes you have an org_id. Replace 'YOUR_ORG_ID_HERE' with actual org UUID
-- You can get your org_id by running: SELECT id FROM organizations LIMIT 1;
-- ============================================================

-- For demo purposes, we'll use a placeholder org_id
-- Replace this with your actual org_id when running
DO $$
DECLARE
  demo_org_id UUID := 'YOUR_ORG_ID_HERE';  -- REPLACE THIS
...
-- 1. Acme Corporation
INSERT INTO clients (
  id, org_id, name, logo, logo_color, industry, website, status,
...
INSERT INTO stakeholders (
  org_id, client_id, full_name, avatar_color, job_title, email, phone, timezone,
